...
const WhyTradeWithUsArr: ContentType[] = [
    {
        ...
        image_alt: '_t_Market time_t_',
    },
    {
        title: '_t_No commissions_t_',
        icon: NoCommisionSVG,
        image_alt: '_t_No money_t_',
    },
    {
        title: '_t_High leverage_t_',
        icon: HighLeverageSVG,
        image_alt: '_t_High percentage_t_',
    },
    {
        title: '_t_11 world indices_t_',
        icon: ElevenIndicesSVG,
        image_alt: '_t_World indices_t_',
    },
    {
        title: '_t_40+ stocks_t_',
        icon: FourtyStocksSVG,
        image_alt: '_t_Stocks_t_',
    },
    {
        title: '_t_Low capital requirement_t_',
        icon: LowCapitalSVG,
        image_alt: '_t_Capital need_t_',
    },
]

const WhyTradeWithUsArr_eu: ContentType[] = [
    {
        title: '_t_Extended market hours_t_',
        icon: ExtendedTimeSVG,
        image_alt: '_t_Market time_t_',
...
const Stocks = ({ pageContext }: TGatsbyHead) => {
    ...
    return (
        <Layout is_ppc_redirect region={region}>
            ...
            <DTrading trading={blueChips} setWidth="486px" reverse contentMargin="24px" />
            <WhyTradeWithUs
